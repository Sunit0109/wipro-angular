...
@Directive({
  selector: '[appLifecycleExample]',
  standalone: true
})
export class LifecycleExampleDirective implements OnChanges, OnInit, DoCheck, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnDestroy {
